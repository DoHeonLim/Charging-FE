  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="flex flex-col space-y-8"> {/* 전체 섹션 간 간격 추가 */}
          <div className="flex flex-row space-x-8">
            <div className="flex-1 flex flex-col space-y-8"> {/* 필드 간 간격 추가 */}
              <FormField
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex items-center space-x-4"> {/* 간격 조정 */}
                  ...
                  <div className="flex items-center space-x-3"> {/* 내부 간격 조정 */}
                    <FormControl>
                      <Checkbox
                        id="hasCarYes"
                        checked={hasCar.includes("있음")}
                        onCheckedChange={(checked) => handleHasCarChange(checked as boolean, "있음")}
                      />
                    </FormControl>
                    ...
                    <FormControl>
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleHasCarChange(checked as boolean, "없음")}
                      />
                    </FormControl>
